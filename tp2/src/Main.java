public class Main {
    ...
    public static void main(String[] args) {
        ...
        //equipos por grupo con mayor puntaje y cambio los valores booleanos en los casos necesarios
        ...
        if (resultadoPartido3.ganoLocal() == true && resultadoPartido4.ganoLocal() == false) {
            ...
            Resultado resultadoPartido17 = new Resultado(3, 1, true, false);
        }
        ...
        if (resultadoPartido5.ganoLocal() == false && resultadoPartido7.ganoLocal() == true) {
            ...
            boolean a = equipo10.isLocal() == true;
            boolean b = equipo13.isLocal() == false;
            Resultado resultadoPartido18 = new Resultado(0, 1, false, false);
        }

        //grupo 3: Túnez y Japón
        if (resultadoPartido10.ganoLocal() == false && resultadoPartido12.ganoLocal() == false) {
            llave3.addPartido(new Partido(19 / 12 / 2022, equipo20, equipo24));
            boolean c = equipo20.isLocal() == true;
            Resultado resultadoPartido19 = new Resultado(1, 3, false, false);
        }

        //grupo 4: Uruguay y Suiza
        if (resultadoPartido13.ganoLocal() == false && resultadoPartido16.ganoLocal() == false) {
            llave4.addPartido(new Partido(20 / 12 / 2022, equipo26, equipo32));
            boolean d = equipo26.isLocal() == true;
            Resultado resultadoPartido20 = new Resultado(2, 0, true, false);
        }
        ...
        //llave1: equipo5 y equipo13 / llave2: equipo24 y equipo26
        llavesemi1.addPartido(new Partido(21/12/2022, equipo5, equipo13));
        Resultado resultadoprimerasemi = new Resultado(2, 1, true, false);

        llavesemi2.addPartido(new Partido(22/12/2022, equipo24, equipo26));
        Resultado resultadosegundasemi = new Resultado(1, 3, false, false);

        if (resultadoprimerasemi.ganoLocal()==true){
            if (resultadosegundasemi.ganoLocal()==false){
                Llave llavefinal = new Llave();
                llavefinal.addPartido(new Partido(23/12/2022, equipo5, equipo26));
                Resultado resultadofinal = new Resultado(2, 3, false, false);
                System.out.println("Ganador del mundial: " + equipo26);
            }
        }
    }
}